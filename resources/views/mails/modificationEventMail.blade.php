...
<body>
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-body">
                <div>
                    <h3 class="inline">{{$employee->full_name}} se modificó el evento al que se te invitó {{$event->name}}:</h3>
                </div>
                <br>
                <div>
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: left;">{{$event->start_date}}</td>
                            </tr>
                            <tr>
                                <td style="text-align: left;">Fin:</td>
                                <td style="text-align: left;">{{$event->end_date}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">{{$event->total_days}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <br>
                <div>
                    <label for="listDays">Desglose de los días de evento: </label>
                    <ol name="listDays">
                ...
                <div style="text-align: left">
                    <label class="form-label">Haz clic en la siguiente liga para entrar al sistema: </label>
                    <br>
