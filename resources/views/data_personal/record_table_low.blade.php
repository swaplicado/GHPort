    ...
    <table class="table table-bordered" id="{{$table_id}}" ref="{{$table_ref}}" width="100%" cellspacing="0">
        ...
        <tbody>
            <tr v-for="User in DataUser">
                ...
                <td>@{{User.name}}</td>
                <td style="text-align: center;"><button v-on:click="downloadLow(User.id, false)" :id="User.id" type="button" class="btn3d btn-info" style="display: inline-block; margin-right: 5px" title="Ver y descargar">
                    <span class="bx bxs-download"></span></button></td>
                <td style="text-align: center;"><button v-on:click="downloadLow(User.id, true)" :id="User.id" type="button" class="btn3d btn-info" style="display: inline-block; margin-right: 5px" title="Ver y descargar">
                    <span class="bx bxs-download"></span></button></td>
            </tr>
        </tbody>
    </table>
