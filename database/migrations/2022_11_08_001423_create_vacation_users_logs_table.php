...
class CreateVacationUsersLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vacation_users_logs', function (Blueprint $table) {
            $table->bigIncrements('id_vacation_user_log');
            $table->date('date_log');
    ...
    {
        Schema::dropIfExists('vacation_users_logs');
    }
}
