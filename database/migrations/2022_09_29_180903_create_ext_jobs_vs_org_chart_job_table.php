...
class CreateExtJobsVsOrgChartJobTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ext_jobs_vs_org_chart_job', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('ext_job_id');
            $table->unsignedBigInteger('org_chart_job_id_n')->nullable();
            $table->timestamps();

            $table->foreign('ext_job_id')->references('id_job')->on('ext_jobs')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('ext_jobs_vs_org_chart_job');
    }
}
