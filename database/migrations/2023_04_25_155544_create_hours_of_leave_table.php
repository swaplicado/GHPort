...
class CreateHoursOfLeaveTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hours_leave', function (Blueprint $table) {
            ...
            $table->string('folio_n')->nullable();
            $table->date('start_date');
            $table->date('end_date');
            $table->date('date_send_n')->nullable();
            ...
            $table->unsignedBigInteger('user_apr_rej_id')->nullable();
            $table->date('approved_date_n')->nullable();
            $table->date('rejected_date_n')->nullable();
            $table->text('sup_comments_n')->nullable();
            $table->text('emp_comments_n')->nullable();
    ...
    {
        Schema::dropIfExists('hours_leave');
    }
}
