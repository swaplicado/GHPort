...
class EmployeesVacationsController extends Controller
{
    ...
    public function employeesDirectIndex(){
        ...
        foreach($lEmployees as $emp){
            ...
            foreach($emp->vacation as $vac){
                ...
                $vac_request = \DB::table('applications as a')
                ...
                if(!is_null($gozadas)){
                    ...
                    $vac->remaining = $vac->vacation_days - collect($gozadas)->sum('day_consumption') - $vac->request;
                }else{
                    $vac->gozadas = null;
                    $vac->num_vac_taken = 0;
    ...
    public function allEmployeesIndex(){
        ...
        // $lEmployees = $this->getAlllEmployees(2, $config);
