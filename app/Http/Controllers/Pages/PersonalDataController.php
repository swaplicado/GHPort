...
class PersonalDataController extends Controller
{
    ...
    public static function getWorkRecord(Request $request){
        ...
        $dateFormatBenefit = $fechaString->locale('es')->isoFormat('D [de] MMMM [de] YYYY');
         ...
         '</strong> '.$config->work_record->paragraph7.'<strong> '.$data->nameCompany.', </strong> '.$config->work_record->paragraph3.'<strong> '.$config->work_record->paragraph8. ' '.$data->rgg_fiscal. ' '
